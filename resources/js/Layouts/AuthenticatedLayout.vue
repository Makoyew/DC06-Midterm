                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-6">
                            ...
                            <div class="relative inline-flex items-center ml-3">
                                <button @click="darkTheme = !darkTheme" class="relative m-5">
                                    <div
                                    class="w-10 h-5 bg-gray-300 rounded-full shadow-inner"
                                    >
                                    <div
                                        :class="[darkTheme ? 'bg-black' : 'bg-yellow-300', 'w-5 h-5 rounded-full shadow-md transform duration-200 ease-in-out']"
                                        :style="{ transform: darkTheme ? 'translateX(100%)' : 'translateX(0)' }"
                                    ></div>
                                    </div>
                                </button>
